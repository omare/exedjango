...
{% if compressor_config %}
	tinyMCE_GZ.init({"themes" : "{{compressor_config.themes}}",
	 "languages" : "{{compressor_config.languages}}",
	 "debug" : {{compressor_config.debug}},
	 "diskcache" : {{compressor_config.diskcache}}, 
	 "plugins" : "{{compressor_config.plugins}}"});
{% endif %}
