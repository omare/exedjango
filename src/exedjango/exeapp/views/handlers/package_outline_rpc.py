...
from exeapp.shortcuts import get_package_by_id_or_error, jsonrpc_helper
...
@jsonrpc_helper('package.add_child_node')
...
@jsonrpc_helper('package.delete_current_node')
...
@jsonrpc_helper('package.change_current_node')
...
@jsonrpc_helper('package.rename_current_node')
...
@jsonrpc_helper('package.promote_current_node')
...
@jsonrpc_helper('package.demote_current_node')
...
@jsonrpc_helper('package.move_current_node_up')
...
@jsonrpc_helper('package.move_current_node_down')
