...
class FieldNotFoundException(Exception):
    '''Field was not found while processing an request'''
    pass
...
class TextElement(Element):
    ...
    edit_template_path = "exe/idevices/elements/textfield/edit.html"
    preview_template_path = "exe/idevices/elements/textfield/preview.html"
    export_template_path = "exe/idevices/elements/textfield/export.html"
    ...
    def process(self, arguments):
        ...
        try:
            self.field.content = arguments[self.field.unique_name]
            self.field.save()
        except KeyError:
            raise FieldNotFoundException("Field %s was not found." %\
